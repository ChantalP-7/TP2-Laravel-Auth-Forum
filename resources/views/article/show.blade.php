    ...
    <div class="col-md-6">              
        <div class="card mb-4 border-0">
            <div class="card-header text-white background-title rounded-0 pt-2 mb-4  pb-0">
                <h5 class="card-title klee-one-regular fs-4">{{ is_array($article->title) ? $article->title[app()->getLocale()] : $article->title }} ({{ app()->getLocale() }})
            ...
            <div>
                <a href="{{route('article.pdf', $article->id)}}" class="btn btn-lg btn-warning">PDF</a>
            </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        @lang('messages.Are you sure to delete the article:' ) <strong> {{ is_array($article->title) ? $article->title[app()->getLocale()] : $article->title }} ({{ app()->getLocale() }})</strong>?
      </div>
